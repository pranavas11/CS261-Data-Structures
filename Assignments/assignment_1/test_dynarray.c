/*
 * This file contains executable code for testing your dynamic array implementation.
 */
...
void test_dynarray(struct student** students, int n) {
  ...
  /*
   * Test removing elements from the dynamic array by removing the copies of repl that were inserted above.
   */
  printf("\n");
  for (i = n - 1; i > 0; i /= 2) {
