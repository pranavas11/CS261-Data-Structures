/*
 * This file contains a simple implementation of a dynamic array. See the documentation below for more information on the individual functions in this implementation.
 */
...
/*
 * This function allocates and initializes a new, empty dynamic array and returns a pointer to it.
 */
...
/*
 * This function frees the memory associated with a dynamic array. Freeing any memory associated with values stored in the array is the responsibility of the caller.
 *
 * Parameter:
...
/*
 * This function returns the size of a given dynamic array (i.e. the number of elements stored in it, not the capacity).
 */
...
/*
 * This function returns the capacity of the given dynamic array (i.e. the total number of elements the array can store).
 */
...
/*
 * Auxilliary function to perform a resize on a dynamic array's underlying storage array.
 */
void _dynarray_resize(struct dynarray* da, int new_capacity) {
	  ...
	  for (int i = 0; i < da->size; i++) {
		  physical = (da->front + i) % da->capacity;
...
/*
 * This function inserts a new value to a given dynamic array. The new element is always inserted at the *end* of the array.
 *
 * Parameters:
...
void dynarray_insert(struct dynarray* da, void* val) {
	  ...
	  /*
	   * Make sure we have enough space for the new element and resize if needed.
	   */
	   ...
	   */
	  da->data[(da->size + da->front) % da->capacity] = val;
	  da->size++;
}

/*
 * This function removes an element at a specified index from a dynamic array. All existing elements following the specified index are moved forward to fill in the gap left by the removed element.
 *
 * Parameters:
...
/*
 * This function returns the top value in a dynamic array.
 *
 * Parameters:
 *   da - the dynamic array from which to get a value (may not be NULL)
 */
void* get_top(struct dynarray* da) {
	return da->data[da->front];
}

/*
 * This function removes the top value in a dynamic array.
 *
 * Parameters:
 *   da - the dynamic array from which to get a value (may not be NULL)
 */
void* remove_top(struct dynarray* da) {
	void* front_var = da->data[da->front];
	da->front += 1;
	if (da->front == da->capacity) da->front = 0;
	da->size -= 1;
	return front_var;
}

/*
 * This function updates (i.e. overwrites) the value of an existing element in a dynamic array.
 *
 * Parameters:
