/*
 * This file contains the definition of the interface for the queue-from-stacks you'll implement. You can find descriptions of the queue-from-stacks functions, including their parameters and their return values, in queue_from_stacks.c. You should not modify anything in this file.
 */
...
/*
 * Queue-from-stacks interface function prototypes. Refer to queue_from_stacks.c for documentation about each of these functions.
 */
