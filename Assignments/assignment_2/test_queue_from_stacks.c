/*
 * This file contains executable code for testing your queue-from-stacks implementation.
 */
...
int main(int argc, char** argv) {
   ...
   * Simulate a queue in the simqueue array (with current front/back kept track of in simfront/simback).
   */
  ...
  /*
   * Dequeue a few of the values held in the queue and make sure they're the correct values.
   */
  ...
  /*
   * Dequeue the remaining values held in the queue and make sure they're the correct values.
   */
