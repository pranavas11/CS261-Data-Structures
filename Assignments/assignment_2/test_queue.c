...
int main(int argc, char** argv) {
  ...
  /*
   * Create queue and enqueue part of the testing data into it.  Simulate a queue in the simqueue array (with current front/back kept track of in simfront/simback).
   */
  q = queue_create();
